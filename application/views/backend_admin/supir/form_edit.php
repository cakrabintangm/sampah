                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-sm-12">
                      ...
                      <select disabled="" class="form-control" name="jenis_titik" id="jenis_titik_1" onchange="jenis_titik_2()" >
                        ...
                        <option  selected="" value="supir">Supir</option>
                      </select>                        
                    </div>
                    
                   <form style="display: block;" id="id_supir" action="<?=base_url('master-data/proses_supir/'.$data[0]['id_supir'])?>" method='post'>
                    <div class="row">
                      <div class="col-sm-12">
                        <br>
                        <label class="col-sm-4 control-label" id="latitude" >Latitude</label>
                        <input value="<?php echo $data[0]['latitude'] ?>"  type="text" id="latitude_supir" name="latitude_supir" class="form-control" placeholder="latitude">
                      </div>
                      <div class="col-sm-12">
                        <br>
                        <label class="col-sm-4 control-label" id="longitude" >Longitude</label>
                        <input value="<?php echo $data[0]['longitude'] ?>"  type="text" id="longitude_supir" name="longitude_supir" class="form-control" placeholder="Longtitude" >
                      </div>
                      <div class="col-sm-12">
                        <br>
                        <label  id="label_alamat" class="col-sm-4 control-label">Alamat</label>
                        <input value="<?php echo $data[0]['alamat'] ?>" type="text" id="alamat_supir" name="alamat_supir" class="form-control" placeholder="Alamat" >
                      </div>
                      <div class="col-sm-12">
                        <br>
                        <label  id="label_supir" class="col-sm-4 control-label">Nama Supir</label>
                        <input value="<?php echo $data[0]['nm_supir'] ?>"  type="text" id="nama_supir" name="nama_supir" class="form-control" placeholder="Nama Supir" >
                      </div>
                        <div class="col-sm-12">
                        <label  id="label_angkutan" class="col-sm-8 control-label">Jenis Angkutan</label>
                        <select  class="form-control" id="jenis_angkutan" name="jenis_angkutan" >
                          <option value="">-- Pilihan --</option>
                          <option <?php if($data[0]['id_ang']==1){echo "selected";} ?> value="1">Dump Truk</option>
                          <option <?php if($data[0]['id_ang']==2){echo "selected";} ?> value="2">Pick Up</option>
                        </select>
                      </div>
                      <br>
                    </div>
