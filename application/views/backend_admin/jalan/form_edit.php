    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url().'master-data/keluar'?>" class="nav-link">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-sm-12">
                      ...
                      <select disabled="" class="form-control" name="jenis_titik" id="jenis_titik_1" onchange="jenis_titik_2()" >
                        ...
                        <option selected="" value="jalan">Jalan</option>
                        <option value="supir">Supir</option>
                      </select>                        
                    </div>
                    
    <form style="display: block;" id="id_jalan" action="<?=base_url('master-data/proses_jalan/'.$data[0]['id_jalan'])?>" method='post'>
                    <div class="row">

                      <div class="col-sm-12">
                        <br>
                        <label class="col-sm-4 control-label" id="latitude" >Latitude</label>
                        <input value="<?php echo $data[0]['latitude'] ?>"  type="text" id="latitude_jalan" name="latitude_jalan" class="form-control" placeholder="latitude">
                      </div>

                       <div class="col-sm-12">
                        <br>
                        <label class="col-sm-4 control-label" id="latitude" >Nama</label>
                        <input  value="<?php echo $data[0]['nama'] ?>" type="text"  name="nama" class="form-control" placeholder="Nama">
                      </div>

                      <div class="col-sm-12">
                        <br>
                        <label class="col-sm-4 control-label" id="longitude" >Longitude</label>
                        <input value="<?php echo $data[0]['longitude'] ?>"  type="text" id="longitude_jalan" name="longitude_jalan" class="form-control" placeholder="Longtitude">
                      </div>
                      
                      <div class="col-sm-12">
                        <br>
                        <label  id="label_alamat" class="col-sm-4 control-label">Alamat</label>
                        <input value="<?php echo $data[0]['alamat'] ?>"  type="text" id="alamat_jalan" name="alamat_jalan" class="form-control" placeholder="Alamat" >
                      </div>
                      <br>
